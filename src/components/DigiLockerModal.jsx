  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-[4px] border border-slate-300 shadow-2xl w-full max-w-2xl overflow-hidden z-10 flex flex-col">
        ...
        {/* Step Indicator Bar */}
        <div className="bg-slate-100 px-5 py-2.5 border-b border-slate-200 flex items-center justify-between text-xs font-semibold">
          <div className="flex items-center gap-2">
            <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[11px] ${
              step >= 1 ? 'bg-[#1B365D] text-white font-bold' : 'bg-slate-300 text-slate-700'
            }`}>1</span>
            <span className={step === 1 ? 'text-[#1B365D] font-bold' : 'text-slate-600'}>Authenticate</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={step === 2 ? 'text-[#1B365D] font-bold' : 'text-slate-600'}>DEPA Consent</span>
          </div>
          <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={step === 3 ? 'text-[#1B365D] font-bold' : 'text-slate-600'}>Select Docs</span>
          </div>
          <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={step >= 4 ? 'text-emerald-800 font-bold' : 'text-slate-600'}>X.509 Verify</span>
          </div>
        </div>
